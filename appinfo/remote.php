...
//$baseuri = OC_App::getAppWebPath('ocdownloader').'appinfo/remote.php';
...
if($user_id){
  require_once 'chooser/lib/ip_auth.php';
	OC_Log::write('ocdownloader','user_id '.$user_id,OC_Log::WARN);
...
OC_Log::write('ocdownloader',"USER: ".OC_User::getUser()." : ".$user,OC_Log::WARN);
...
require_once('ocdownloader/lib/ocDownloader'.$provider.'.class.php');

$parsed_url = parse_url($url);
$pathinfo = pathinfo($parsed_url['path']);
$myprovider = 'OC_ocDownloader'.$provider;
